...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-indigo-600/15 rounded-full blur-3xl" />
      ...
      >
        ...
        <div className="bg-gray-900/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm mt-1">Sign in to your HiyanBlog account</p>
          </div>
